...
public class instrumental extends AppCompatActivity  {
    ...
    LinearLayout T1,T2,T3,T4,T5,T6,T7,T8,T9,T10;
    String equipo;
    ...
    public void saveData(){
        ...
        if (equipo.equals("bascula")) {
            equipo = "EQUIPOBASCULA";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("bisturi")) {
            equipo = "EQUIPOBISTURI";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("extractor")) {
            equipo = "EQUIPOEXTRACTOR";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("glucometro")) {
            equipo = "EQUIPOGLUCOMETRO";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("hojalari")) {
            equipo = "EQUIPOHOJALARI";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("laringo")) {
            equipo = "EQUIPOLARINGO";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("mofetal")) {
            equipo = "EQUIPOMOFETAL";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("negatos")) {
            equipo = "EQUIPONEGATOS";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("octamo")) {
            equipo = "EQUIPOOCTAMO";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("otos")) {
            equipo = "EQUIPOOTOS";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("oximetro")) {
            equipo = "EQUIPOOXIMETRO";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("videolaringo")) {
            equipo = "EQUIPOVIDEOLARINGO";
            editor.putString(equipo,"LISTO");
        }
    ...
    public void loadData() {
        ...
        if (equipo.equals("bisturi")){
            TX1.setText("BISTURI ARMONICO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("extractor")){
            TX1.setText("EXTRACTOR DE SENAL ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("glucometro")){
            TX1.setText("GLUCOMETRO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("hojalari")){
            TX1.setText("HOJA LARINGOSCOPIO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("laringo")){
            TX1.setText("LARINGOSCOPIO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("mofetal")){
            TX1.setText("MONITOR FETAL ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("negatos")){
            TX1.setText("NEGATOSCOPIO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("octamo")){
            TX1.setText("OCTALMOSCOPIO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("otos")){
            TX1.setText("OTOSCOPIO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("oximetro")){
            TX1.setText("OXIMETRO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("videolaringo")){
            TX1.setText("VIDEOLARINGO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
    }
    public void setText(String nequipo){
        ...
        T12.setText("2) CABLE AC / ALIMENTACION");T22.setText("2) CABLE AC / ALIMENTACION");T32.setText("2) CABLE AC / ALIMENTACION");
        T42.setText("2) CABLE AC / ALIMENTACION");T52.setText("2) CABLE AC / ALIMENTACION");T62.setText("2) CABLE AC / ALIMENTACION");
        T72.setText("2) CABLE AC / ALIMENTACION");T82.setText("2) CABLE AC / ALIMENTACION");T92.setText("2) CABLE AC / ALIMENTACION");
        T102.setText("2) CABLE AC /ALIMENTACION");
        ...
        if(equipo.equals("hojalari")){
            T1.setVisibility(View.GONE);T2.setVisibility(View.GONE);T3.setVisibility(View.GONE);T4.setVisibility(View.GONE);T5.setVisibility(View.GONE);
            T6.setVisibility(View.GONE);T7.setVisibility(View.GONE);T8.setVisibility(View.GONE);T9.setVisibility(View.GONE);T10.setVisibility(View.GONE);

            T13.setText("2) FUNCIONAMIENTO NORMAL");T23.setText("2) FUNCIONAMIENTO NORMAL");T33.setText("2) FUNCIONAMIENTO NORMAL");
            T43.setText("2) FUNCIONAMIENTO NORMAL");T53.setText("2) FUNCIONAMIENTO NORMAL");T63.setText("2) FUNCIONAMIENTO NORMAL");
            T73.setText("2) FUNCIONAMIENTO NORMAL");T83.setText("2) FUNCIONAMIENTO NORMAL");T93.setText("2) FUNCIONAMIENTO NORMAL");
            T103.setText("2) FUNCIONAMIENTO NORMAL");
        }
    }
