...
public class inmobiliario extends AppCompatActivity  {
    ...
    TextView TX1,T11,T12,T13,T21,T22,T23,T31,T32,T33,T41,T42,T43,T51,T52,T53,T61,T62,T63,T71,T72,T73,T81,T82,T83,T91,T92,T93,T101,T102,T103;
    String equipo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.instrumental);
        ...
        T11 = (TextView)findViewById(R.id.textViewm11);
        T12 = (TextView)findViewById(R.id.textViewm12);
        T13 = (TextView)findViewById(R.id.textViewm13);
        T21 = (TextView)findViewById(R.id.textViewm21);
        T22 = (TextView)findViewById(R.id.textViewm22);
        T23 = (TextView)findViewById(R.id.textViewm23);
        T31 = (TextView)findViewById(R.id.textViewm31);
        T32 = (TextView)findViewById(R.id.textViewm32);
        T33 = (TextView)findViewById(R.id.textViewm33);
        T41 = (TextView)findViewById(R.id.textViewm41);
        T42 = (TextView)findViewById(R.id.textViewm42);
        T43 = (TextView)findViewById(R.id.textViewm43);
        T51 = (TextView)findViewById(R.id.textViewm51);
        T52 = (TextView)findViewById(R.id.textViewm52);
        T53 = (TextView)findViewById(R.id.textViewm53);
        T61 = (TextView)findViewById(R.id.textViewm61);
        T62 = (TextView)findViewById(R.id.textViewm62);
        T63 = (TextView)findViewById(R.id.textViewm63);
        T71 = (TextView)findViewById(R.id.textViewm71);
        T72 = (TextView)findViewById(R.id.textViewm72);
        T73 = (TextView)findViewById(R.id.textViewm73);
        T81 = (TextView)findViewById(R.id.textViewm81);
        T82 = (TextView)findViewById(R.id.textViewm82);
        T83 = (TextView)findViewById(R.id.textViewm83);
        T91 = (TextView)findViewById(R.id.textViewm91);
        T92 = (TextView)findViewById(R.id.textViewm92);
        T93 = (TextView)findViewById(R.id.textViewm93);
        T101 = (TextView)findViewById(R.id.textViewm101);
        T102 = (TextView)findViewById(R.id.textViewm102);
        T103 = (TextView)findViewById(R.id.textViewm103);
    ...
    public void saveData(){
        ...
        if (equipo.equals("prevacio")) {
            equipo = "EQUIPOPREVACIO";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("bandaesfuerzo")) {
            equipo = "EQUIPOBANDAESFUERZO";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("baumapared")) {
            equipo = "EQUIPOBAUMAPARED";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("camah")) {
            equipo = "EQUIPOCAMAH";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("camat")) {
            equipo = "EQUIPOCAMAT";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("carroparo")) {
            equipo = "EQUIPOCARROPARO";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("cuna")) {
            equipo = "EQUIPOCUNA";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("impresora")) {
            equipo = "EQUIPOIMPRESORA";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("mesaq")) {
            equipo = "EQUIPOMESAQ";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("modulosg")) {
            equipo = "EQUIPOMODULOSG";
            editor.putString(equipo,"LISTO");
        }
        if (equipo.equals("sellador")) {
            equipo = "EQUIPOSELLADOR";
            editor.putString(equipo,"LISTO");
        }
    ...
    public void loadData() {
        ...
        if (equipo.equals("prevacio")){
            TX1.setText("ALMACEN PREVACIO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("bandaesfuerzo")){
            TX1.setText("BANDA DE ESFUERZO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("baumapared")){
            TX1.setText("BAUMANOMETRO DE PARED ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("camah")){
            TX1.setText("CAMA HOSPITALARIA / GINE ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("camat")){
            TX1.setText("CAMILLA DE TRASLADO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("carroparo")){
            TX1.setText("CARRO DE PARO ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("cuna")){
        ...
        if (equipo.equals("impresora")){
            TX1.setText("IMPRESORA ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("mesaq")){
            TX1.setText("MESA QUIRURGICA ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("modulosg")){
            TX1.setText("MODULO DE GASES Y AC ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
        if (equipo.equals("sellador")){
            TX1.setText("SELLADOR DE BOLSAS ");
            nequipo=TX1.getText().toString();
            setText(nequipo);
        }
    ...
    public void setText(String nequipo){
        ...
        T11.setText("1) ESTADO FISICO");T21.setText("1) ESTADO FISICO");T31.setText("1) ESTADO FISICO");
        T41.setText("1) ESTADO FISICO");T51.setText("1) ESTADO FISICO");T61.setText("1) ESTADO FISICO");
        T71.setText("1) ESTADO FISICO");T81.setText("1) ESTADO FISICO");T91.setText("1) ESTADO FISICO");T101.setText("1) ESTADO FISICO");

        T12.setText("2) CABLE AC CONECTADO");T22.setText("2) CABLE AC CONECTADO");T32.setText("2) CABLE AC CONECTADO");
        T42.setText("2) CABLE AC CONECTADO");T52.setText("2) CABLE AC CONECTADO");T62.setText("2) CABLE AC CONECTADO");
        T72.setText("2) CABLE AC CONECTADO");T82.setText("2) CABLE AC CONECTADO");T92.setText("2) CABLE AC CONECTADO");T102.setText("2) CABLE AC CONECTADO");

        T13.setText("3) FUNCIONAMIENTO NORMAL");T23.setText("3) FUNCIONAMIENTO NORMAL");T33.setText("3) FUNCIONAMIENTO NORMAL");
        T43.setText("3) FUNCIONAMIENTO NORMAL");T53.setText("3) FUNCIONAMIENTO NORMAL");T63.setText("3) FUNCIONAMIENTO NORMAL");
        T73.setText("3) FUNCIONAMIENTO NORMAL");T83.setText("3) FUNCIONAMIENTO NORMAL");T93.setText("3) FUNCIONAMIENTO NORMAL");
        T103.setText("3) FUNCIONAMIENTO NORMAL");

        if(equipo.equals("carroparo") || equipo.equals("camat") || equipo.equals("camah") || equipo.equals("cuna")){
            T12.setText("2) MOVILIDAD");T22.setText("2) MOVILIDAD");T32.setText("2) MOVILIDAD");
            T42.setText("2) MOVILIDAD");T52.setText("2) MOVILIDAD");T62.setText("2) MOVILIDAD");
            T72.setText("2) MOVILIDAD");T82.setText("2) MOVILIDAD");T92.setText("2) MOVILIDAD");T102.setText("2) MOVILIDAD");
        }
        if(equipo.equals("baumapared")){
            T12.setText("2) PRESION CORRECTA");T22.setText("2) PRESION CORRECTA");T32.setText("2) PRESION CORRECTA");
            T42.setText("2) PRESION CORRECTA");T52.setText("2) PRESION CORRECTA");T62.setText("2) PRESION CORRECTA");
            T72.setText("2) PRESION CORRECTA");T82.setText("2) PRESION CORRECTA");T92.setText("2) PRESION CORRECTA");T102.setText("2) PRESION CORRECTA");

            T13.setText("3) CIRCUITO SIN FUGAS");T23.setText("3) CIRCUITO SIN FUGAS");T33.setText("3) CIRCUITO SIN FUGAS");
            T43.setText("3) CIRCUITO SIN FUGAS");T53.setText("3) CIRCUITO SIN FUGAS");T63.setText("3) CIRCUITO SIN FUGAS");
            T73.setText("3) CIRCUITO SIN FUGAS");T83.setText("3) CIRCUITO SIN FUGAS");T93.setText("3) CIRCUITO SIN FUGAS");T103.setText("3) CIRCUITO SIN FUGAS");
        }
        if(equipo.equals("modulosg")){
            T12.setText("2) CONTACTOS AC");T22.setText("2) CONTACTOS AC");T32.setText("2) CONTACTOS AC");
            T42.setText("2) CONTACTOS AC");T52.setText("2) CONTACTOS AC");T62.setText("2) CONTACTOS AC");
            T72.setText("2) CONTACTOS AC");T82.setText("2) CONTACTOS AC");T92.setText("2) CONTACTOS AC");T102.setText("2) CONTACTOS AC");

            T13.setText("3) TOMAS DE O2 Y AIRE");T23.setText("3) TOMAS DE O2 Y AIRE");T33.setText("3) TOMAS DE O2 Y AIRE");
            T43.setText("3) TOMAS DE O2 Y AIRE");T53.setText("3) TOMAS DE O2 Y AIRE");T63.setText("3) TOMAS DE O2 Y AIRE");
            T73.setText("3) TOMAS DE O2 Y AIRE");T83.setText("3) TOMAS DE O2 Y AIRE");T93.setText("3) TOMAS DE O2 Y AIRE");T103.setText("3) TOMAS DE O2 Y AIRE");
        }
    }
